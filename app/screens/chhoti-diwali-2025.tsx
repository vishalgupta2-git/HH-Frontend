...
export default function ChhotiDiwali2025Screen() {
  ...
  const parseTextContent = (text: string) => {
    ...
    if (tocItems.length === 0) {
      ...
      sections.push({
        title: isHindi ? 'छोटी दीवाली 2025' : 'Chhoti Diwali 2025',
  ...
  const fetchChhotiDiwaliContent = async () => {
    try {
      setLoading(true);
      setError(null);
      
      // Direct S3 URL for Chhoti Diwali content
      const response = await fetch('https://hinduheritage-public-bucket.s3.ap-south-1.amazonaws.com/chhotiDiwali.txt');
      ...
      console.error('Error fetching Chhoti Diwali content:', error);
  ...
  const onRefresh = async () => {
    setRefreshing(true);
    await fetchChhotiDiwaliContent();
    setRefreshing(false);
  };
        ...
        <View style={styles.card}>
          <View style={styles.contentHeader}>
            ...
            <View style={styles.titleContainer}>
              <Text style={styles.screenTitle}>{isHindi ? 'छोटी दीवाली 2025' : 'Chhoti Diwali 2025'}</Text>
            </View>
          </View>

          <View style={styles.loadingContainer}>
            <Text style={styles.loadingText}>{isHindi ? 'छोटी दीवाली 2025 सामग्री लोड हो रही है...' : 'Loading Chhoti Diwali 2025 content...'}</Text>
          </View>
        </View>
      </View>
    );
      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.errorContainer}>
            ...
            <TouchableOpacity style={styles.retryButton} onPress={fetchChhotiDiwaliContent}>
