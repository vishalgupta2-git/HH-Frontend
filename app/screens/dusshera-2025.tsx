...
export default function Dusshera2025Screen() {
    ...
    if (tocMatches) {
      ...
      if (sectionMatches) {
        sectionMatches.forEach(match => {
          ...
          if (title.match(/\d{2}\s+(Oct|अक्तूबर)/) || title.includes('Dashmi') || title.includes('दशमी')) {
            tocItems.push(title);
          }
        });
      }
  ...
  const fetchDussheraContent = async () => {
    try {
      setLoading(true);
      setError(null);
      
      // Direct S3 URL for Dusshera content
      const response = await fetch('https://hinduheritage-public-bucket.s3.ap-south-1.amazonaws.com/dusshera.txt');
      ...
      console.error('Error fetching Dusshera content:', error);
        ...
        <View style={styles.card}>
          <View style={styles.contentHeader}>
            ...
            <View style={styles.titleContainer}>
              <Text style={styles.screenTitle}>{isHindi ? 'दशहरा 2025' : 'Dusshera 2025'}</Text>
            </View>
          </View>

          <View style={styles.loadingContainer}>
            <Text style={styles.loadingText}>{isHindi ? 'दशहरा 2025 सामग्री लोड हो रही है...' : 'Loading Dusshera 2025 content...'}</Text>
          </View>
        </View>
      </View>
    );
      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.errorContainer}>
            ...
            <TouchableOpacity style={styles.retryButton} onPress={fetchDussheraContent}>
