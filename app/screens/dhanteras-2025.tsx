...
export default function Dhanteras2025Screen() {
  ...
  const parseTextContent = (text: string): { tocItems: TocItem[]; sections: Section[] } => {
    ...
    if (tocItems.length === 0) {
      ...
      sections.push({
        title: isHindi ? 'धनतेरस 2025' : 'Dhanteras 2025',
  ...
  const fetchDhanterasContent = async () => {
    try {
      setLoading(true);
      setError(null);
      
      // Direct S3 URL for Dhanteras content
      const response = await fetch('https://hinduheritage-public-bucket.s3.ap-south-1.amazonaws.com/Dhanteras.txt');
      ...
      console.error('Error fetching Dhanteras content:', error);
        ...
        <View style={styles.card}>
          <View style={styles.contentHeader}>
            ...
            <View style={styles.titleContainer}>
              <Text style={styles.screenTitle}>{isHindi ? 'धनतेरस 2025' : 'Dhanteras 2025'}</Text>
            </View>
          </View>

          <View style={styles.loadingContainer}>
            <Text style={styles.loadingText}>{isHindi ? 'धनतेरस 2025 सामग्री लोड हो रही है...' : 'Loading Dhanteras 2025 content...'}</Text>
          </View>
        </View>
      </View>
    );
      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.errorContainer}>
            ...
            <TouchableOpacity style={styles.retryButton} onPress={fetchDhanterasContent}>
