...
export default function Diwali2025Screen() {
  ...
  const parseTextContent = (text: string) => {
    ...
    if (tocItems.length === 0) {
      ...
      sections.push({
        title: isHindi ? 'दीवाली 2025' : 'Diwali 2025',
  ...
  const fetchDiwaliContent = async () => {
    try {
      setLoading(true);
      setError(null);
      
      // Direct S3 URL for Diwali content
      const response = await fetch('https://hinduheritage-public-bucket.s3.ap-south-1.amazonaws.com/Diwali.txt');
      ...
      console.error('Error fetching Diwali content:', error);
        ...
        <View style={styles.card}>
          <View style={styles.contentHeader}>
            ...
            <View style={styles.titleContainer}>
              <Text style={styles.screenTitle}>{isHindi ? 'दीवाली 2025' : 'Diwali 2025'}</Text>
            </View>
          </View>

          <View style={styles.loadingContainer}>
            <Text style={styles.loadingText}>{isHindi ? 'दीवाली 2025 सामग्री लोड हो रही है...' : 'Loading Diwali 2025 content...'}</Text>
          </View>
        </View>
      </View>
    );
      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.errorContainer}>
            ...
            <TouchableOpacity style={styles.retryButton} onPress={fetchDiwaliContent}>
