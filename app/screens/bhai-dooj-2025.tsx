...
export default function BhaiDooj2025Screen() {
  ...
  const parseTextContent = (text: string) => {
    ...
    if (tocItems.length === 0) {
      ...
      sections.push({
        title: isHindi ? 'भाई दूज 2025' : 'Bhai Dooj 2025',
  ...
  const fetchBhaiDoojContent = async () => {
    try {
      setLoading(true);
      setError(null);
      
      // Direct S3 URL for Bhai Dooj content
      const response = await fetch('https://hinduheritage-public-bucket.s3.ap-south-1.amazonaws.com/BhaiDooj.txt');
      ...
      console.error('Error fetching Bhai Dooj content:', error);
        ...
        <View style={styles.card}>
          <View style={styles.contentHeader}>
            ...
            <View style={styles.titleContainer}>
              <Text style={styles.screenTitle}>{isHindi ? 'भाई दूज 2025' : 'Bhai Dooj 2025'}</Text>
            </View>
          </View>

          <View style={styles.loadingContainer}>
            <Text style={styles.loadingText}>{isHindi ? 'भाई दूज 2025 सामग्री लोड हो रही है...' : 'Loading Bhai Dooj 2025 content...'}</Text>
          </View>
        </View>
      </View>
    );
      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.errorContainer}>
            ...
            <TouchableOpacity style={styles.retryButton} onPress={fetchBhaiDoojContent}>
