...
export default function AhoiAshtami2025Screen() {
  ...
  const parseTextContent = (text: string): { tocItems: TocItem[]; sections: Section[] } => {
    ...
    if (tocItems.length === 0) {
      ...
      sections.push({
        title: isHindi ? 'अहोई अष्टमी 2025' : 'Ahoi Ashtami 2025',
  ...
  const fetchAhoiAshtamiContent = async () => {
    try {
      setLoading(true);
      setError(null);
      
      // Direct S3 URL for Ahoi Ashtami content
      const response = await fetch('https://hinduheritage-public-bucket.s3.ap-south-1.amazonaws.com/AhoiAshtami.txt');
      ...
      console.error('Error fetching Ahoi Ashtami content:', error);
        ...
        <View style={styles.card}>
          <View style={styles.contentHeader}>
            ...
            <View style={styles.titleContainer}>
              <Text style={styles.screenTitle}>{isHindi ? 'अहोई अष्टमी 2025' : 'Ahoi Ashtami 2025'}</Text>
            </View>
          </View>

          <View style={styles.loadingContainer}>
            <Text style={styles.loadingText}>{isHindi ? 'अहोई अष्टमी 2025 सामग्री लोड हो रही है...' : 'Loading Ahoi Ashtami 2025 content...'}</Text>
          </View>
        </View>
      </View>
    );
      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.errorContainer}>
            ...
            <TouchableOpacity style={styles.retryButton} onPress={fetchAhoiAshtamiContent}>
