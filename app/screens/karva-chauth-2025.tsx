...
export default function KarvaChauth2025Screen() {
  ...
  const parseTextContent = (text: string) => {
    ...
    if (tocItems.length === 0) {
      ...
      sections.push({
        title: isHindi ? 'करवा चौथ 2025' : 'Karva Chauth 2025',
  ...
  const fetchKarvaChauthContent = async () => {
    try {
      setLoading(true);
      setError(null);
      
      // Direct S3 URL for Karva Chauth content
      const response = await fetch('https://hinduheritage-public-bucket.s3.ap-south-1.amazonaws.com/karwachauth.txt');
      ...
      console.error('Error fetching Karva Chauth content:', error);
        ...
        <View style={styles.card}>
          <View style={styles.contentHeader}>
            ...
            <View style={styles.titleContainer}>
              <Text style={styles.screenTitle}>{isHindi ? 'करवा चौथ 2025' : 'Karva Chauth 2025'}</Text>
            </View>
          </View>

          <View style={styles.loadingContainer}>
            <Text style={styles.loadingText}>{isHindi ? 'करवा चौथ 2025 सामग्री लोड हो रही है...' : 'Loading Karva Chauth 2025 content...'}</Text>
          </View>
        </View>
      </View>
    );
      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.errorContainer}>
            ...
            <TouchableOpacity style={styles.retryButton} onPress={fetchKarvaChauthContent}>
